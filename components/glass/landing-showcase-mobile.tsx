...
export function LandingShowcaseMobile() {
  ...
  return (
    <div className="mx-auto mt-10 w-full max-w-md">
      <div
        className={cn(
          "relative overflow-hidden rounded-[2rem] border border-white/[0.08] bg-neutral-950 p-5 shadow-xl",
          "bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,oklch(0.55_0.18_265_/_0.35),transparent_55%)]",
        )}
      >
        <p className="mb-4 text-center text-[10px] font-semibold uppercase tracking-[0.2em] text-white/45">
            ...
            <div className={cn(getGlassCardClasses(card), "w-full")}>
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[11px] text-white/55">Glass UI</p>
                </div>
              </div>
            </div>
          </div>
